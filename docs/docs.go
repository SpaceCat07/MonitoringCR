...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/cr/lazy/approval-to-complete": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/cr/lazy/approval-to-release": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/dashboard/lifecycle-line-chart": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Year filter (default: current year)",
                        "name": "year",
                        "in": "query"
                    }
                ],
        ...
        "/api/dashboard/module-health-overview": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/dashboard/top-pic": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit (default: 5, max: 5)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/api/spr/draft": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Draft CR payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.createDraftRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "controllers.createActivityRequest": {
            ...
            "properties": {
                ...
                "reply_to_id": {
                    "description": "Optional: for replying to activities",
                    "type": "integer"
                }
            }
        },
        ...
        "controllers.createDraftRequest": {
            "type": "object",
            "required": [
                "title"
            ],
